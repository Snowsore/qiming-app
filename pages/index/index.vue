		...
		<view class="form">
			...
			<view class="form-input">
				<view class="form-item">
					<view class="label">中文姓氏<text>*</text></view>
				...
				<view class="hint">
					...
					<view><qm-checkbox :checked.sync="agreeTerm"></qm-checkbox>同意个人隐私协议</view>
				</view>
			</view>
		</view>
